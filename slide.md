...
![bg right:45% fit](assets/1/tgs_core_concept.png)
...
![bg right:46% fit](assets/1/tgs_interference_heat_source.png)
...
![bg right:52% fit](assets/1/triso_tgs_q_direction.png)
...
![bg right:56% fit](assets/1/high_temp_tgs_setup_full.png)
...
![bg right:53% fit](assets/1/uv_time_gated_raman_setup.png)
...
![bg right:52% fit](assets/1/sic_sphp_concept.png)
...
![bg right:56% fit](assets/1/lfa_tdtr_anchor_workflow.png)
